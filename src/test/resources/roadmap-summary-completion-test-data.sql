...
insert into releases (id, product_id, code, description, status, planned_start_date, planned_release_date, actual_release_date, released_at, owner, notes, created_by, created_at, updated_by, updated_at) values
(1, 1, 'IDEA-2023.3.8', 'IntelliJ IDEA 2023.3.8 - Bug fixes and performance improvements', 'RELEASED', '2023-10-01 09:00:00', '2023-11-15 17:00:00', '2023-11-10 10:00:00', null, 'jane.smith', 'Stable release with critical bug fixes', 'admin','2023-03-25 00:00:00', 'jane.smith', '2023-11-10 10:30:00'),
(2, 1, 'IDEA-2024.2.3', 'IntelliJ IDEA 2024.2.3 - New features and improvements', 'COMPLETED', '2024-01-10 09:00:00', '2024-02-20 17:00:00', null, null, 'john.doe', 'Major release with new AI-powered features', 'admin','2024-02-25 00:00:00', 'john.doe', '2024-02-25 14:30:00'),
(3, 1, 'IDEA-2024.2.4', 'IntelliJ IDEA 2024.2.4 - New features and improvements', 'IN_PROGRESS', '2024-02-21 09:00:00', '2024-04-20 17:00:00', null, null, 'john.doe', 'Minor release with more features', 'admin','2024-02-25 00:00:00', 'john.doe', '2024-02-25 14:30:00'),
(4, 2, 'GO-2024.2.3', 'GoLand 2024.2.4 - Enhanced tooling - Without planned release date', 'RELEASED', '2024-01-05 09:00:00', null, '2024-02-15 11:00:00', null, 'jane.smith', 'Enhanced debugging and profiling tools', 'admin','2024-02-15 00:00:00', 'jane.smith', '2024-02-15 11:30:00'),
(5, 3, 'WEB-2024.2.3', 'WebStorm 2024.2.4 - Web development tools - 13 days delay', 'RELEASED', '2024-01-08 09:00:00', '2024-02-16 09:00:00', '2024-02-29 09:00:00', null, 'jane.smith', 'Improved TypeScript and React support', 'admin','2024-02-29 00:00:00', 'jane.smith', '2024-02-29 09:30:00'),
(6, 4, 'PY-2024.2.3', 'PyCharm 2024.2.4 - Python development - 14 days delay', 'DELAYED', '2024-01-12 09:00:00', '2024-02-18 17:00:00', '2024-03-03 17:00:00', null, 'jane.smith', 'Enhanced data science and ML support', 'admin','2024-03-03 00:00:00', 'jane.smith', '2024-03-03 17:30:00'),
(7, 4, 'PY-2024.2.4', 'PyCharm 2024.3.0 - Cancelled release', 'CANCELLED', '2024-04-01 09:00:00', '2024-06-15 17:00:00', null, '2024-06-16 10:00:00', 'john.doe', 'Planning phase for next major release', 'admin','2024-03-15 00:00:00', 'john.doe', '2024-03-15 10:00:00'),
(8, 4, 'PY-2024.3.0', 'PyCharm 2024.3.0 - Draft release', 'DRAFT', '2024-04-01 09:00:00', '2024-06-15 17:00:00', null, null, 'john.doe', 'Planning phase for next major release', 'admin','2024-03-15 00:00:00', 'john.doe', '2024-03-15 10:00:00'),
(9, 4, 'PY-2024.3.1', 'PyCharm 2024.3.1 - Planned release', 'PLANNED', '2024-05-01 09:00:00', '2024-07-20 17:00:00', null, null, 'jane.smith', 'Planned for Q3 release', 'admin','2024-04-01 00:00:00', 'jane.smith', '2024-04-01 10:00:00'),
(10, 5, 'RIDER-2024.2.6', 'Rider 2024.2.6 - .NET development', 'RELEASED', '2024-01-14 09:00:00', '2024-02-20 17:00:00', '2024-02-16 15:00:00', null, 'jane.smith', 'Improved C# and .NET framework support', 'admin','2024-02-16 00:00:00', 'jane.smith', '2024-02-16 15:30:00')
;
