...
import com.sivalabs.ft.features.listener.async.FeatureAuditEventListener;
...
public class FeatureEventKafkaIntegrationTest extends AbstractIT {
    ...
    @MockitoBean
    private FeatureAuditEventListener featureAuditEventListener;
