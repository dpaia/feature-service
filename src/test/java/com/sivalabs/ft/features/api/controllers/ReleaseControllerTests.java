...
class ReleaseControllerTests extends AbstractIT {
    ...
    void shouldGetAtRiskReleases() {
        // Use dynamic dates relative to now to avoid time-bomb test failures
        var atRiskDate =
                LocalDate.now().plusDays(30).atStartOfDay(ZoneOffset.UTC).toInstant();
        var safeDate =
                LocalDate.now().plusDays(400).atStartOfDay(ZoneOffset.UTC).toInstant();
        ...
        var atRiskPayload =
            ...
            """
                        .formatted(formatter.format(atRiskDate));
        ...
        var safePayload =
            ...
            """
                        .formatted(formatter.format(safeDate));
        ...
        assertThat(result)
                ...
                .extractingPath("$.content")
                .asArray()
                .anySatisfy(item -> assertThat(item.toString()).contains("code=IDEA-ATRISK-30-DAYS"))
