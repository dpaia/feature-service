...
public class RoadmapControllerIntegrationTests extends AbstractIT {
    ...
    void shouldValidateHealthIndicatorsInResponse() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            for (Map<String, Object> item : roadmapItems) {
                ...
                // Timeline adherence can be DELAYED, ON_SCHEDULE, CRITICAL, or null if plannedReleaseDate is missing
                String timelineAdherence = (String) healthIndicators.get("timelineAdherence");
                assertThat(timelineAdherence).isIn("ON_SCHEDULE", "DELAYED", "CRITICAL", null);
            }
        });
    }
    ...
    void shouldValidateReleaseFieldsInResponse() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            assertThat(releaseWithFeatures).isNotNull();
    ...
    void shouldCalculateTimelineAdherenceForUpcomingReleases() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            for (Map<String, Object> item : roadmapItems) {
                ...
                // Timeline adherence can be null if plannedReleaseDate is missing
                assertThat(timelineAdherence).isIn("ON_SCHEDULE", "DELAYED", "CRITICAL", null);
            }
        });
    }
    ...
    void shouldValidateTimelineAdherenceValues() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            for (Map<String, Object> item : roadmapItems) {
                ...
                // Timeline adherence must be one of the valid values or null if plannedReleaseDate is missing
                assertThat(timelineAdherence).isIn("ON_SCHEDULE", "DELAYED", "CRITICAL", null);
            }
        });
    }
    ...
    void shouldReturnNullTimelineAdherenceWhenPlannedReleaseDateMissing() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            boolean foundReleaseMissingPlannedDate = false;
            for (Map<String, Object> item : roadmapItems) {
                Map<String, Object> release = (Map<String, Object>) item.get("release");
                Map<String, Object> healthIndicators = (Map<String, Object>) item.get("healthIndicators");
                ...
                if (plannedReleaseDate == null) {
                    foundReleaseMissingPlannedDate = true;
                    assertThat(timelineAdherence)
                            .as("TimelineAdherence must be null when plannedReleaseDate is missing")
                            .isNull();
                }
            }
            assertThat(foundReleaseMissingPlannedDate)
                    .as("Test data should contain at least one release without plannedReleaseDate")
                    .isTrue();
        });
    }
    ...
    void shouldReturnOnScheduleWhenActualReleaseDateBeforePlanned() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            boolean foundOnScheduleRelease = false;
            for (Map<String, Object> item : roadmapItems) {
                Map<String, Object> release = (Map<String, Object>) item.get("release");
                Map<String, Object> healthIndicators = (Map<String, Object>) item.get("healthIndicators");
                ...
                // Skip releases without plannedReleaseDate (they will have null timelineAdherence)
                if (plannedReleaseDate == null) {
                    assertThat(timelineAdherence).isNull();
                    continue;
                }
                ...
                if (releaseDateOnly.compareTo(plannedDate) <= 0) {
                    foundOnScheduleRelease = true;
                    assertThat(timelineAdherence)
                            .as("Release on %s should be ON_SCHEDULE when planned for %s", releaseDateOnly, plannedDate)
                            .isEqualTo("ON_SCHEDULE");
                }
            }
            assertThat(foundOnScheduleRelease)
                    .as("Test should have found at least one release released on or before planned date (ON_SCHEDULE)")
                    .isTrue();
        });
    }
    ...
    void shouldReturnDelayedWhenDelay0To13Days() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            fail("Test should have found at least one DELAYED release (0-13 days late)");
        });
    }
    ...
    void shouldReturnCriticalWhenDelay14DaysOrMore() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            boolean foundCriticalDelay = false;
            for (Map<String, Object> item : roadmapItems) {
                Map<String, Object> release = (Map<String, Object>) item.get("release");
                Map<String, Object> healthIndicators = (Map<String, Object>) item.get("healthIndicators");
                ...
                // Skip releases without plannedReleaseDate
                if (plannedReleaseDate == null) {
                    assertThat(timelineAdherence).isNull();
                    continue;
                }
            ...
            assertThat(foundCriticalDelay)
                    .as("Test should have found at least one release with 14+ days delay (CRITICAL)")
                    .isTrue();
        });
    }
    ...
    void shouldValidate14DayBoundary() throws Exception {
        ...
        assertThat(result).hasStatusOk().bodyJson().convertTo(Map.class).satisfies(response -> {
            ...
            assertThat(found13DayDelay || found14DayDelay)
                    .as("Test data should contain at least one release with 13 or 14 days delay to verify boundary")
                    .isTrue();
        });
    }
