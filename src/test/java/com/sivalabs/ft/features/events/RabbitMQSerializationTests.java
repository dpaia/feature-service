 ...
 */
@Import(RabbitMQSerializationTests.TestRabbitListenerConfig.class)
class RabbitMQSerializationTests extends AbstractIT {

    private static final Logger log = LoggerFactory.getLogger(RabbitMQSerializationTests.class);
