...
public class FeatureEventListener {
    ...
    public void handleFeatureCreatedEvent(
        ...
        eventDeduplicationService.executeIdempotentWithMetadata(
                event.eventId(), EventType.EVENT, "CREATED", event.id(), event.code(), event, () -> {
    ...
    public void handleFeatureUpdatedEvent(
        ...
        eventDeduplicationService.executeIdempotentWithMetadata(
                event.eventId(), EventType.EVENT, "UPDATED", event.id(), event.code(), event, () -> {
    ...
    public void handleFeatureDeletedEvent(
        ...
        eventDeduplicationService.executeIdempotentWithMetadata(
                event.eventId(), EventType.EVENT, "DELETED", event.id(), event.code(), event, () -> {
