...
public class RoadmapService {
    ...
    public RoadmapResponseDto getRoadmap(RoadmapFilterDto filter) {
        ...
        List<RoadmapItemDto> roadmapItems = releases.stream()
                .map(release -> createRoadmapItem(release, filter))
    ...
    @Transactional(readOnly = true)
    public RoadmapResponseDto getMultiProductRoadmap(List<String> productCodes, RoadmapFilterDto filter) {
        ...
        return getRoadmap(multiProductFilter);
    }

    @Transactional(readOnly = true)
    public RoadmapResponseDto getRoadmapByOwner(String owner, RoadmapFilterDto filter) {
        ...
        return getRoadmap(ownerFilter);
    }

    @Transactional(readOnly = true)
    public ByOwnerRoadmapResponseDto getStructuredRoadmapByOwner(String owner, RoadmapFilterDto filter) {
        ...
        RoadmapResponseDto roadmapResponse = getRoadmap(ownerFilter);
    ...
    public MultiProductRoadmapResponseDto getGroupedMultiProductRoadmap(
            List<String> productCodes, RoadmapFilterDto filter) {
    ...
    private RoadmapItemDto createRoadmapItem(Release release) {
        return createRoadmapItem(release, null);
    }

    private RoadmapItemDto createRoadmapItem(Release release, RoadmapFilterDto filter) {
        ...
        List<FeatureDto> featureDtos =
                features.stream().map(featureMapper::toDto).collect(Collectors.toList());
