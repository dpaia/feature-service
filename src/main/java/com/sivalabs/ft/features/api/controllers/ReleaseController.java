...
class ReleaseController {
    ...
    @Operation(
            ...
            description = "Get all features assigned to a release with planning details",
            responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successful response",
    ...
    List<FeatureDto> getFeaturesByRelease(@PathVariable String releaseCode) {
        return featureService.findFeaturesWithPlanningByReleaseCode(releaseCode);
    }
