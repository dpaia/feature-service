...
/**
 * ApplicationLifecycleListener handles Spring ApplicationContext lifecycle events
 ...
 */
@Component
@ConditionalOnBean({KafkaTemplate.class, AdminClient.class})
public class ApplicationLifecycleListener {
    ...
    public void onApplicationShutdown(ContextClosedEvent event) {
        ...
        // Database connections are automatically closed by Spring Boot's DisposableBean mechanism
    ...
    /**
     * Verifies Kafka connectivity and checks that all required topics are accessible.
