...
class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(c -> c.requestMatchers(
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/planning/health/**")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/planning/trends/**")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/planning/capacity/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
